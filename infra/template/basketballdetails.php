...
<div class="col-md-4">
<h5 class="">The Rim</h5>
<input type="text" class="form-control" name="basketballform_info|court_rim" id="corimheight" placeholder="The rims height (in meters)">
</div>

<div class="col-md-4">
<h5 class="">The Center Circle</h5>
<input type="text" class="form-control" name="basketballform_info|center_circle" id="centcirclediameter" placeholder="The center circle diameter (in meters)">
</div>
<div class="col-md-4">
<h5 class="">The No Charge Zone arc</h5>
<input type="text" class="form-control" name="basketballform_info|nocharge_zone" id="nochzonearc" placeholder="The No Charge Zone arc (in meters)">
</div>
</div>
<br>
